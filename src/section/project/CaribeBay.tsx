...
export default function CaribeBay() {
    return <ProjectContainer>
        ...
        <p className="prose mx-auto">
            Ho sviluppato un sistema di prenotazione smart per il gruppo Caribe Bay, parco a tema acquatico di Jesolo, che introduce il concetto di coda virtuale per le attrazioni. L'app permette agli ospiti di prenotare il proprio accesso a scivoli e attrazioni con un anticipo di quindici, trenta o quarantacinque minuti, evitando così l'attesa fisica in coda. Questo sistema migliora l'esperienza degli ospiti, rendendoli più soddisfatti e liberi di esplorare il parco durante l'attesa, contribuendo così a un incremento potenziale dei consumi all'interno del parco.
        </p>
