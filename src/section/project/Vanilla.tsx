...
export default function Vanilla() {
    return <ProjectContainer>
        <ProjectHead
            ...
            icon={<img className="rounded-lg h-16 w-16 shadow-xl shadow-gray-400" src="/icons/vanilla.png" alt="Vanilla Club Jesolo" />}
        />
        ...
        <p className="prose mx-auto">
            Sul lato amministrativo, l'app fornisce un sistema di reportistica avanzata per monitorare in tempo reale l'andamento delle metriche chiave, permettendo di prendere decisioni strategiche. Inoltre, l'app permette di minimizzare le perdite economiche del locale, con una percentuale di mancati pagamenti inferiore allo 0,05%. L'app integra un sistema POS, la gestione aziendale tramite PMS, controllo del magazzino (carico/scarico) e gestione di stampanti fiscali e comande.
        </p>
